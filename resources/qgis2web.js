...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [492057.927130, 6550256.859153, 495289.936308, 6552013.386699], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([492057.927130, 6550256.859153, 495289.936308, 6552013.386699], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Intégration d’imageries géospatiales et de données collaboratives pour analyse du changement écologique</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (1907 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Cette cartographie examine les dynamiques spatio-temporelles de la Réserve Naturelle de Genappe, incluant les anciens bassins de décantation, au moyen d’une intégration multimodale d’imageries géospatiales et de données naturalistes collaboratives. Nous mobilisons un ensemble de sources complémentaires : <br />(i) un modèle de hauteur de canopée dérivé du HighResCanopyHeight (HRCH) pour quantifier les variations structurelles de la végétation ligneuse ;<br /> (ii) des orthophotographies historiques et contemporaines à haute résolution pour détecter les transitions phytosociologiques fines et les dynamiques de fermeture/ouverture du milieu ; et <br />Ces informations sont corrélées avec un corpus exhaustif d’observations naturalistes multi-taxons issues de dispositifs de science citoyenne (observations.be), couvrant la faune vertébrée et invertébrée ainsi que la flore et divers groupes indicateurs. L’analyse vise à évaluer les relations fonctionnelles entre les changements biophysiques détectés par télédétection et les réponses spatio-temporelles des assemblages d’espèces (abondance, fréquence, phénologie, distributions locales). Une attention particulière est portée aux espèces indicatrices des stades de succession, aux taxons sensibles aux modifications hydromorphologiques des anciens bassins, et aux groupes dépendants des structures fines de micro-habitats.<br />L’intégration analytique effectuée met en évidence des trajectoires de transformation contrastées, révélant des processus simultanés d’embroussaillement, de colonisation arborée et de dynamisme végétal différentiel au sein de la mosaïque d’habitats. Ce couplage entre télédétection haute résolution et données collaboratives offre un cadre méthodologique robuste pour la modélisation des changements écosystémiques et constitue un support décisif pour l’orientation des stratégies de gestion et de conservation au sein de la RND de Genappe.';
            }
